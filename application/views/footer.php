...
<script type="text/javascript" src="/tmp/static/lib/ckeditor/ckeditor.js"></script>
<script type="text/javascript">
    CKEDITOR.replace('description', {
        'filebrowserUploadUrl':'/tmp/topic/upload_receive_from_ck'
    });
   ...
   // CKEDITOR.config.autoGrow_maxHeight = 600;
    ...
    CKEDITOR.config.height = 1200;        // 500 pixels high.
    CKEDITOR.config.height = '25em';     // CSS unit (em).
    CKEDITOR.config.width = 850;     // 850 pixels wide.
